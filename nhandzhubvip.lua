...
spawn(function() 
    ...
    wait(1.5)
    require(game.ReplicatedStorage.Notification).new("<Color=Red> WELECOM TO Nhân Dz Hub<Color=/>"):Display()
    require(game.ReplicatedStorage.Notification).new("<Color=Blue>THÔNG BÁO:Hub V1 nên ít chức năng sẽ sớm update cho ae<Color=/>"):Display()
end)

local Fluent = loadstring(game:HttpGet("https://raw.githubusercontent.com/obfalchx/testfluent/refs/heads/main/FluentTrau"))()
local SaveManager = loadstring(game:HttpGet("https://raw.githubusercontent.com/obfalchx/testfluent/refs/heads/main/FluentTrau"))()
local InterfaceManager = loadstring(game:HttpGet("https://raw.githubusercontent.com/obfalchx/testfluent/refs/heads/main/FluentTrau"))()
...
local Tabs = {
	Home= Window:AddTab({ Title = "Tab Home", Icon = "" }),
    Main = Window:AddTab({ Title = "Tab Farm", Icon = "" }),
    Sea = Window:AddTab({ Title = "Tab Sea", Icon = "" }),
    Draco = Window:AddTab({ Title = "Tab Draco", Icon = "" }),
    ITM= Window:AddTab({ Title = "Tab Item", Icon = "" }),
    Levi = Window:AddTab({ Title = "Tab Fram Levi", Icon = "" }),
    Hop = Window:AddTab({ Title = "Tap Hop sever", Icon = "" }),
    ...
    Visual = Window:AddTab({ Title = "Tabs Fake", Icon = "" }),
...
local v47= Tabs.Main:AddSection("Farming")
